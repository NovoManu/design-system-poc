...
function useLocalObservable(initializer, annotations) {
    return React.useState(function () { return observable(initializer(), annotations, { autoBind: true }); })[0];
}
...
function Button(props) {
  var state = useLocalObservable(function () {
    return {
      ...
      get componentStyles() {
        ...
        var themeColor = themeColors[props.theme] || themeColors["default"];
        var types = {
          Primary: themeColor["color-primary"]["200"],
          Secondary: themeColor["color-secondary"]["200"]
        };
        var defaultType = types["Primary"];
        var sizes = {
          Small: {
        ...
        var padding = "".concat(sizes[props.size].paddingTopBottom || defaultSize.paddingTopBottom, " ").concat(sizes[props.size].paddingLeftRight || defaultSize.paddingLeftRight);
        return {
  ...
  return /*#__PURE__*/React__namespace.createElement(React__namespace.Fragment, null, !state.loading ? /*#__PURE__*/React__namespace.createElement(React__namespace.Fragment, null, /*#__PURE__*/React__namespace.createElement("button", {
...
//# sourceMappingURL=dsf-react.umd.js.map
