...
function Button(props) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, !state.loading ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("button", {
    style: state.componentStyles,
    className: state.componentClasses
  }, props.text)) : null);
}

export { Button, Input, colors, darkColors, screens, spacing, xmasColors };
//# sourceMappingURL=dsf-react.es.js.map
